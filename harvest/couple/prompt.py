...
TEMPLATE = (
    ...
    "tip now; fading pale-green line = the tip over the last {trace_s:g} s; spring-green arrow = the motion the "
    "policy has committed for the next 0.5 s; chartreuse (yellow-green) arrow = your previous correction still "
    "being applied; short red / green / blue lines at the tip = robot frame x / y / z. On wrist images the overlay "
    "is only a small box in the top-right corner.\n"
