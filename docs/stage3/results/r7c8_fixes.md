...
| **N8** H 인자 | E §4.12·M4 §4.4 "H 1과 3 비교" | `closed --m4-h`(:283, 기본 3), `closed.m4_config(cond, H)`(:151–160, H < 1 거부), 워커 `m4=m4_config(...)`(:227), 스펙·`meta.m4_H`(:396, :424) [정정 R7 10회차 D1, 정본 §75: 인자만 전달했고 H = 1의 사전 등록 정의("같은 스텝을 앞당겨 2~3회 묻기")가 없어 스텝당 표 1개·확정 0이었다 → `m4.early_ask_steps`·`--m4-lead-max`] |
...
| 29 | T_c 0.33 / H 1·3 비교 (E :487, M4 :272-273) | `m4.py:43-44`; `closed.py:151-160,283` `--m4-h` | **일치(N8 수정)** [정정 R7 10회차 D1: 불일치였음 — H = 1 앞당겨 묻기 없음, 정본 §75] |
