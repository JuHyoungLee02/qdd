...
- **상태는 책에 적지 않는다**(2026-09-25 21:07 UTC, R7 28회차, 함정 P69): '진행 중·생성 중·미커밋' 같은 현재 상태는 `docs/handoff.md`에만 UTC 시각과 함께 쓰고, 책에는 위치·확정 결과·결정만 둔다. 실험 장부의 상태 칸은 `예정`·`끝`·`중단`처럼 커밋으로 바뀌는 값만 쓴다.
