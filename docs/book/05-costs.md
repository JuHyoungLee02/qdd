...
| E-Astra-motion G1 v2 (정지 영상 40장 × 4조건, low) | 160 | **2,682원** | 호출당 **16.8원**, 입력 약 507/657/811(영상 1/2/3장), 출력 약 75(추론 약 22), 지연 p50 **3.5 s** | [R/astra_motion](../stage3/results/astra_motion.md) 2절 |
| E-Astra-motion S2 직렬 흐름 (F0·F1 각 3편, low) | 72 (+ 끝난 뒤 도착 6) | **3,824원** | 호출당 **49.7원(F0)·58.0원(F1)**, 입력 2,207/2,486, 출력 244/302, 지연 p50 **9.3 s(F0)·10.3 s(F1)**, 첫 토큰 약 6 s, 로봇 1분당 350–500원, 캐시 적중 0 | 같은 문서 5절 |
