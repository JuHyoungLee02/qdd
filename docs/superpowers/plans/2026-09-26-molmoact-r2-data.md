...
- 2026-09-26 05:2x UTC(Task 1 뒤, 측정 전 계산): M6 각도 조건 통과율 f — 짝 배치 eval 시드 90개에서 시작 손끝 (0.34, −0.25) → 자기 대상 직선 접근 중 자기 대상 xy ≥ 10 cm이고 두 방향 각 ≥ 75°인 점이 있는 편 비율 머그 0.51·병 0.53(k0만 보면 0.10 — 그래서 스냅샷은 접근 구간 전체에서 고른다). 예상 M6 편 ≈ 180 × (0.585 × 0.51 + 0.99 × 0.53) ≈ 148 ≥ 100 → 크기 유지. 두 대상 영상 거리 중앙값 94 px(최소 61, 규칙 ≥ 60).
