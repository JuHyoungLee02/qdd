...
마지막 갱신: 2026-09-25 10:00 UTC (R1–R6 완료, R7 순회 중 — 회차별 판정·연속 무결 횟수는 §2.8 마지막 줄, 정본 §1~§77)

> 현재 판본: 정본 `00-interfaces.md` **§1~§77**(뒤 절이 앞 절을 덮는다). 단계 3 이전 판본(plan v6.8, SUMMARY v3.10, §1의 v5.6)은 옛 기록이다. 단계 3 이후 최신 상태는 §2.7·§2.8.
...
- **먼저 읽을 것**: `docs/superpowers/plans/2026-09-25-e2e-ready.md`(현재 계획: 관문 R1–R7 → S-E2E), `docs/design/00-interfaces.md` §43부터 끝까지(지금 §77), `docs/stage3/direction-log.md`(방향 검사 기록), 진행 기록(ledger) `.superpowers/sdd/2026-09-24-stage3-experiments/progress.md`, 결과 문서 `docs/stage3/results/`.
